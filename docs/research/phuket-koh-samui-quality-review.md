...
- 521 repository tests passed.
- Chrome DevTools device emulation confirmed an exact 390×844 CSS viewport, `scrollWidth = 390`, and no horizontal overflow.
- A 1440×1000 desktop capture confirmed `scrollWidth = 1440` with no horizontal overflow.
