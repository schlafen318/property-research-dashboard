...
class MalagaCostaDelSolDossierContractTests(unittest.TestCase):
    ...
    def test_registry_contains_the_four_reviewed_dossiers(self) -> None:
        self.assertEqual(
            {"fukuoka-itoshima", "valencia", "algarve-cascais", "madeira", DESTINATION_ID, "lake-como", "hakone-izu", "hakuba", "costa-brava-girona", "park-city-deer-valley", "crete", "niseko", "annecy"},
