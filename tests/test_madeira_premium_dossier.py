...
class MadeiraDossierContractTests(unittest.TestCase):
    ...
    def test_registry_contains_the_three_reviewed_dossiers(self) -> None:
        self.assertEqual(
            {"fukuoka-itoshima", "valencia", "algarve-cascais", "madeira", "malaga-costa-del-sol", "lake-como", "hakone-izu", "hakuba", "costa-brava-girona", "park-city-deer-valley", "crete", "niseko", "annecy"},
