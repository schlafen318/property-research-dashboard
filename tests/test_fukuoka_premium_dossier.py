...
class PremiumDossierContractTests(unittest.TestCase):
    def test_only_reviewed_prototypes_use_the_premium_registry(self) -> None:
        self.assertEqual({"fukuoka-itoshima", "valencia", "algarve-cascais", "madeira", "malaga-costa-del-sol", "lake-como", "hakone-izu", "hakuba", "costa-brava-girona", "park-city-deer-valley", "crete", "niseko"}, set(PREMIUM_DESTINATION_DOSSIERS))
