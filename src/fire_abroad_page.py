    ...
    for result in default_results:
        ...
        rows.append(
          ...
          <tr data-fire-result="{destination_id}">
            <th scope="row"><a href="/destinations/{destination_id}/" data-fire-track="destination_guide_click" data-fire-destination-id="{destination_id}">{name}</a><span>{escape(status)}</span><small>{status_reason}</small></th>
