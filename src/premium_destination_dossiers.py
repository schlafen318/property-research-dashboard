...
PERTH_MARGARET_RIVER_DOSSIER = PremiumDossierSpec(
    ...
    checklist=(
        ...
        "Overlay current bushfire, flood and coastal information; test evacuation, insurance, cooling, drainage and the hospital route.",
