...
MALLORCA_DOSSIER = PremiumDossierSpec(
    ...
    lede="Mallorca is not one retirement market. Palma offers hospitals, markets, culture and public transport within a working city. Santa Catalina, Portixol and Son Armadans each deliver a different version of that urban life. Calvià, Santa Ponça and Port d'Andratx form a mature southwest buyer market with polished services and premium prices. Sóller and the Tramuntana trade convenience for landscape and character. Pollença and Alcúdia provide an established northern base, while Santanyí and Manacor anchor very different southeast and eastern routines. This dossier asks which address remains practical after summer flights thin, restaurants close and a house needs ordinary care.",
    author="Global Home Atlas Research Team",
    date_published="2026-08-22",
    date_reviewed="2026-08-22",
    verdict_paragraphs=(
