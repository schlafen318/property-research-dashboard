...
QUEENSTOWN_DOSSIER = PremiumDossierSpec(
    ...
    verdict_paragraphs=(
        ...
        "Pause before browsing if the buyer is an overseas person without a qualifying pathway. LINZ says overseas people usually cannot buy a house or land. New Zealand citizens and ordinarily resident residence-class visa holders can buy without restriction; some residence-class visa holders can apply for consent for one home; temporary visa holders generally cannot. A separate pathway effective 6 March 2026 allows qualifying investor-visa holders to seek consent for a home above NZ$5 million. The Temporary Retirement Visitor Visa is still a temporary visa and does not itself solve ordinary residential eligibility. Sensitive-land rules can create an additional consent question near lakes, reserves and other protected features.",
