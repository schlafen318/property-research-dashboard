...
CRETE_DOSSIER = PremiumDossierSpec(
    ...
    h1="Crete property for retirement",
...
MIAMI_FORT_LAUDERDALE_DOSSIER = PremiumDossierSpec(
    destination_id="miami-fort-lauderdale",
    title="Miami and Fort Lauderdale Retirement Property Dossier",
    description="Assess Miami and Fort Lauderdale retirement property through daily life, foreign-buyer rules, condo reserves, flood and insurance exposure, rentals, value, resale, and current listings.",
    h1="Miami / Fort Lauderdale: global access, coastal complexity",
    lede="Miami / Fort Lauderdale offers an unusually complete warm-weather city-and-coast life: two international airports, major hospitals, established neighbourhoods, beaches and a deep resident economy. Yet the home matters more than the skyline. A Brickell tower, a Coral Gables house and a Galt Ocean condominium create different insurance, reserve, flood, mobility and resale decisions. This dossier identifies which pattern can support long-term life—and which costs and rules must be resolved before the view becomes persuasive.",
    author="Global Home Atlas Research Team",
    date_published="2026-08-24",
    date_reviewed="2026-08-24",
    verdict_paragraphs=(
        "Miami / Fort Lauderdale is a strong retirement candidate for a buyer who wants international air access, year-round urban services and warm coastal living, but it is not a low-friction purchase. Property ownership does not create immigration status, Medicare eligibility or a right to remain in the United States. An ordinary home purchase is also not an EB-5 investment: that programme requires investment in a qualifying commercial enterprise and a plan to create or preserve ten permanent full-time jobs. Establish the residence route, health coverage, tax position and ownership structure before selecting a home.",
        "Many foreign individuals can acquire Florida residential property, but the answer is no longer captured by saying that Florida is simply open. Part III of Chapter 692 restricts defined foreign principals and includes specific rules affecting persons and entities connected with foreign countries of concern, with particularly detailed provisions involving the People's Republic of China. Nationality, domicile, entity control, parcel location, proximity rules and statutory exceptions can change the outcome. Florida counsel should clear the exact buyer, entity and parcel before a non-refundable commitment.",
        "The destination works best when the buyer chooses a daily-life system rather than a prestige label. Brickell offers rail, restaurants and an urban apartment routine, but association costs and tower governance are central. Coral Gables and Coconut Grove provide greener, lower-rise living with more private outdoor space, but driving, roof and envelope maintenance grow in importance. Miami Beach adds immediate coast and culture alongside stricter vacation-rental geography, salt exposure and flood diligence. Fort Lauderdale and Galt Ocean can provide a calmer coastal base with FLL and Broward Health nearby, but older-building records, reserves, insurance and assessments require exacting review.",
        "Proceed only after four written answers exist: the buyer may lawfully acquire and remain; the building or house is insurable at a known price; the association, inspection and reserve record supports the budget; and the intended rental or personal use is permitted by the municipality and governing documents. When those answers are sound, Miami / Fort Lauderdale can be a credible year-round home. Without them, apparent liquidity and sunshine can conceal a costly operating mismatch.",
    ),
    lenses_intro="Five questions separate a durable South Florida home from a seductive but fragile purchase: whether ordinary life works, which airport and health network serve the address, what Florida and condominium rules require, whether income survives legal and operating costs, and who can buy the property on exit.",
    lenses=(
        DossierLens(
            "Build a daily life that works beyond the waterfront",
            ("lifestyle_magnetism", "retirement_fit"),
            (
                "The destination's advantage is not only beach weather. Miami-Dade and Broward contain neighbourhood hospitals, supermarkets, restaurants, arts, parks and established residential communities that remain active throughout the year. Brickell and Downtown Miami deliver the most urban version: high-rise living, Metromover and Metrorail access, dense dining and a short route to the civic core. That can reduce daily driving, but tower elevators, valet systems, loading, visitor parking and association rules become part of ordinary life. Test the building at rush hour, during heavy rain and when one elevator is unavailable.",
                "Coral Gables and Coconut Grove trade some vertical convenience for shade, gardens, smaller buildings and houses. The strongest streets make groceries, cafés and parks feel close; other addresses remain car-dependent despite an attractive map. A detached home gives control over space but transfers roof, drainage, trees, impact protection, pool and exterior maintenance to the owner. Miami Beach offers an immediately recognisable coastal life, yet causeway traffic, visitor pressure, salt and wind exposure can turn a short distance into a demanding routine. A retirement choice should be judged on the least glamorous weekly errands, not a weekend itinerary.",
                "Fort Lauderdale has its own centre rather than functioning as a Miami suburb. Las Olas and Downtown combine restaurants, culture and nearby healthcare; Galt Ocean and Lauderdale-by-the-Sea create a more residential coast with grocery and beach access in selected pockets. Broward Health Medical Center is a 24-hour full-service hospital and Level I trauma centre, while Jackson Memorial is a large tertiary teaching hospital serving the Miami side. These institutions support the regional case, but the exact route matters. Drive from the candidate home to the preferred hospital in peak traffic and after a storm-warning closure.",
                "Healthcare financing must be solved separately. Medicare generally serves people aged 65 or older who meet its citizenship or lawful-residency requirements; a newly arrived foreign retiree should not assume immediate eligibility. Price suitable private health coverage, prescriptions and out-of-network exposure before moving. Then test heat, shade, walking surfaces, hurricane preparation, social life outside winter and the practicality of living for a month without a car. Miami / Fort Lauderdale scores well because it offers genuine city depth, not because coastal life is effortless.",
            ),
            "residential-life",
        ),
        DossierLens(
            "Use two gateways without understating the last mile",
            ("global_access", "foreigner_fit"),
            (
                "Miami International Airport is the stronger global gateway, especially toward Latin America and the Caribbean. Its May 2026 network statement listed 176 nonstop destinations and 91 carriers, while 2025 passenger volume exceeded 55 million. Fort Lauderdale-Hollywood International handled about 32.2 million passengers in 2025 and gives Broward residents a materially shorter alternative for many domestic and international journeys. Airport choice should follow the address and route network: a bargain fare is less useful when causeway or interstate congestion consumes the advantage.",
                "Brickell and Coral Gables normally align more naturally with MIA; Galt Ocean and central Fort Lauderdale align with FLL. Miami Beach, Aventura and Lauderdale-by-the-Sea sit between access stories that vary by time of day. Measure the front-door journey with luggage, not the straight-line distance. Confirm parking, ride-hail pickup, late arrivals, accessibility assistance and a backup route during construction or severe weather. South Florida's regional scale is an asset only when the chosen home connects cleanly to the services the household actually uses.",
                "Foreigner fit is high in language, professional services and international familiarity, but administration remains consequential. A nonresident owner may need U.S. tax returns for rental income, and FIRPTA can impose withholding obligations when a foreign person disposes of U.S. real property. Estate exposure, entity choice, financing, beneficial ownership, insurance and state rules can interact. Use independent U.S. and Florida legal and tax advisers rather than accepting a sales-team structure. The practical benefit of an international market is access to capable advisers—not permission to skip them.",
            ),
        ),
        DossierLens(
            "Underwrite the building, the water and the policy",
            ("ownership_clarity", "regulatory_safety"),
            (
                "Florida title can be familiar and transparent, but buyer eligibility still needs the Chapter 692 review described above. For a condominium, title is only one layer. Obtain the declaration, bylaws, current budget, reserve schedule, financial statements, insurance, claims history, board minutes, engineering reports, violations, litigation, arrears, rental rules and pending assessments. Confirm whether parking, storage and amenities are deeded, assigned or revocable. Read the master policy beside an HO-6 quotation so gaps in wind, water, loss assessment and interior coverage are visible before the inspection period expires.",
                "Florida's milestone-inspection and structural-integrity-reserve regime makes building age and governance financially material. Residential condominium and cooperative buildings of three or more habitable stories generally enter milestone inspection at 30 years, or 25 years when the local enforcement agency determines local conditions require it, and then at least every ten years. Structural integrity reserve studies also recur at least every ten years and cover defined structural and building systems. A completed report does not mean the cost disappears: ask what work was identified, funded, contracted, completed and still disputed.",
                "Flood and storm exposure must be resolved at the address. Miami-Dade provides current FEMA flood-zone lookup and warns that being outside a mapped high-risk zone does not mean no flood risk. Obtain the elevation certificate where relevant, identify floor and critical-equipment elevation, inspect drainage and seawall responsibility, and quote flood, wind and homeowners coverage for the exact occupancy. Citizens' current phase-in generally requires flood coverage in 2026 for personal residential wind policies on dwellings with replacement value of at least $400,000, with broader requirements scheduled for 2027; condominium unit-owner policies are listed as exempt from that requirement. This is not a substitute for lender or private-insurer terms.",
                "House diligence is different but no lighter. Inspect roof age and permit history, impact openings, electrical and plumbing systems, drainage, trees, pool equipment, sewer or septic, boundary and unpermitted work. For waterfront property, determine seawall condition, dock rights, permitting and maintenance responsibility. For every home, use current flood and evacuation lookups and ask the insurer what happens after a material claim. Insurance availability and deductible structure can alter financing, carrying cost and the future buyer pool even when the property itself appears sound.",
            ),
            "coastal-diligence",
        ),
        DossierLens(
            "Treat rental use as municipal permission, not a view",
            ("rental_profit", "capital_upside"),
            (
                "South Florida has deep long-term housing demand, but no destination-wide net yield should be applied to an individual property. Brickell rent is shaped by tower supply, association fees, parking and unit condition. Coral Gables and Coconut Grove homes reach different family and professional tenants. Fort Lauderdale beachfront condos may attract seasonal interest but also carry high association and insurance costs. Begin with a twelve-month tenancy supported by matched leases, then deduct vacancy, management, repairs, association charges, insurance, property tax, leasing fees and foreign-owner tax administration.",
                "Vacation rental rules fragment at municipal and building level. Unincorporated Miami-Dade requires the relevant state licence and tax accounts plus an annual Certificate of Use before advertising. Miami Beach prohibits rentals shorter than six months and one day in all single-family homes and many multifamily districts; permitted cases still require local business and tax compliance. Fort Lauderdale requires state and county credentials before city registration, inspection and certificate steps, and limits occupancy by legal bedroom. An HOA or condominium declaration can be stricter than the city. Obtain written confirmation for the exact unit and intended stay length.",
                "Capital upside should be separated from rental enthusiasm. The July 2026 public MLS signals show a broad and liquid region, but not a uniformly rising one: Miami-Dade existing condos had a $400,000 median and 12 months of supply, while Broward existing condos had a $255,000 median and 10 months. Miami-Dade single-family homes had a $685,000 median. These county-wide completed-sale signals exclude much new development and cannot value a particular address. They do show why building, submarket and property type must be analysed separately.",
                "Underwrite three operating cases: lawful long-term tenancy, the exact permitted shorter-stay model, and no rent. In each, include owner-use blocks and realistic insurance and association increases. If only the optimistic short-stay case supports the purchase, the asset is not retirement-resilient. Capital strength is more credible when the home serves a broad resident buyer pool, the building has credible reserves and the future owner can insure it without extraordinary friction.",
            ),
        ),
        DossierLens(
            "Price the complete ownership cycle and the next buyer",
            ("value_entry", "exit_liquidity"),
            (
                "The three current asking observations show three distinct markets rather than a single Miami price. A Brickell one-bedroom asks $659,999 for 810 square feet of living area and carries a stated $1,319 monthly association charge. A Galt Ocean two-bedroom asks $849,000 for 1,650 square feet and carries a stated $1,594 monthly association charge. A renovated Coral Gables house asks $1.48 million for 1,575 square feet. On consistent seller-stated living area, the observations span roughly $5,500 to $10,100 per square metre. That spread is useful precisely because it exposes different operating systems; it is not a market median or valuation.",
                "Model acquisition through exit. A two-percent acquisition-cost allowance can be a planning placeholder for buyer-side title, escrow, legal, inspection and financing work, but it is not a statutory quote and excludes property-specific surprises. Recalculate property tax after ownership changes because prior exemptions and assessed-value limits may not transfer; Florida guidance says a change of ownership removes exemptions and generally resets assessment to just value. Add insurance, flood cover, deductibles, association charges, reserves, assessments, repairs, utilities, health costs, management, travel, federal and state advice and sale costs.",
                "Exit liquidity is strongest when the next buyer can understand and finance the home quickly. Brickell reaches an international and domestic apartment pool, yet elevated association charges or weak reserves can shrink it. Galt Ocean offers more area and direct coast but depends on the exact building record and an older-condo buyer's tolerance for costs. Coral Gables houses reach a broader owner-occupier pool but remain price-, insurance- and condition-sensitive. Ask two agents who did not source the property for matched completed sales, likely days to contract and the objections future buyers will raise.",
                "For a foreign seller, FIRPTA withholding affects closing mechanics even when final tax differs. Estate and ownership structure may also change the result. Preserve original due-diligence records, permits, association disclosures, insurance history and improvement invoices so the next buyer can verify the asset. The best value entry is not the lowest unit price; it is the home whose daily utility, lawful use, five-year carrying cost and future buyer pool stay aligned under a slower market and a harder insurance renewal.",
            ),
        ),
    ),
    score_reads={
        "lifestyle_magnetism": "Miami combines culture, food and waterfront energy; Fort Lauderdale and Galt Ocean offer a calmer coastal rhythm with real year-round services.",
        "global_access": "Miami International anchors the global case, while Fort Lauderdale-Hollywood gives Broward homes a valuable second gateway with a shorter last mile.",
        "ownership_clarity": "Many foreign individuals can buy in Florida, but restricted-foreign-principal, entity, parcel, title and condominium rules require buyer-specific clearance.",
        "regulatory_safety": "Miami and Fort Lauderdale demand building-level reserve, inspection, insurance, flood and municipal rental diligence before price or income comparisons.",
        "rental_profit": "Brickell and Broward have real long-term demand, but association, insurance, tax, municipal and management costs prevent a credible destination-wide net yield.",
        "capital_upside": "Miami's global depth supports selected homes; Broward offers different entry points, while building quality and insurance can dominate appreciation.",
        "retirement_fit": "Miami and Broward offer major hospitals and daily services, but Medicare eligibility, private health cover, heat and driving must be solved personally.",
        "exit_liquidity": "Brickell and Coral Gables reach broad pools; Galt Ocean resale depends more heavily on the exact building, assessments, insurance and buyer financing.",
        "foreigner_fit": "Miami's international professional network is strong, but Florida eligibility, FIRPTA, estate, rental and insurance workstreams remain material for foreign owners.",
        "value_entry": "Miami and Fort Lauderdale asks span sharply different living-area prices; association charges, flood cover and future buyer depth determine true value.",
    },
    market_anchors=(
        {"location": "Miami-Dade existing condominiums", "evidence": "$400,000 median", "buyer_read": "July 2026 closed sales; 12 months of supply and 125 median days to sale. County-wide public MLS signal—not a unit valuation.", "source_label": "MIAMI REALTORS July 2026 report", "source_url": "https://www.miamirealtors.com/2026/08/17/miami-dade-total-home-sales-rise-for-11th-consecutive-month/"},
        {"location": "Miami-Dade single-family homes", "evidence": "$685,000 median", "buyer_read": "July 2026 closed sales, up 3.79% year on year. Broad county and asset signal—not a Coral Gables valuation.", "source_label": "MIAMI REALTORS July 2026 report", "source_url": "https://www.miamirealtors.com/2026/08/17/miami-dade-total-home-sales-rise-for-11th-consecutive-month/"},
        {"location": "Broward existing condominiums", "evidence": "$255,000 median", "buyer_read": "July 2026 closed sales; 10 months of supply and 122 median days to sale. County-wide signal—not a Galt Ocean valuation.", "source_label": "MIAMI REALTORS Broward July 2026 report", "source_url": "https://www.miamirealtors.com/2026/08/17/broward-county-total-home-sales-increase-for-fifth-consecutive-month/"},
    ),
    property_anchor_indexes=(0, 2, 1),
    micro_locations_intro="Choose the operating system before the postcode. These four patterns are decision aids, not price zones; confirm the exact buyer eligibility, municipality, title, association, lawful use, flood layer, insurance and service route.",
    micro_locations=(
        {"name": "Brickell / Downtown Miami", "best_for": "Urban, lower-car daily life", "daily_life": "Rail, dining and dense services with MIA and Jackson Memorial in the wider city system.", "diligence": "Association budget, reserves, milestone work, elevators, parking, flood, insurance, rental term and assessments."},
        {"name": "Coral Gables / Coconut Grove", "best_for": "Greener houses and low-rise living", "daily_life": "Shaded neighbourhoods, parks and village centres; usefulness varies sharply by exact walk and drive.", "diligence": "Roof, impact protection, drainage, trees, pool, permits, insurance, tax reset and future family-buyer pool."},
        {"name": "Miami Beach / Aventura", "best_for": "Coastal condo lifestyle", "daily_life": "Beach, dining and services with causeway or highway dependence for wider Miami journeys.", "diligence": "Municipal rental geography, building age, salt, flood, seawall, evacuation, reserves, master insurance and traffic."},
        {"name": "Las Olas / Galt Ocean", "best_for": "Fort Lauderdale city-and-coast base", "daily_life": "FLL, Broward Health, restaurants and walkable coastal pockets in selected addresses.", "diligence": "Building certification, reserve funding, assessments, wind and flood cover, parking, rental rules and older-condo exit depth."},
    ),
    checklist=(
        "Confirm immigration, Medicare or private health, federal and Florida tax, estate and ownership structure before choosing a home.",
        "Obtain Florida legal clearance for the exact buyer, entity, parcel and Chapter 692 foreign-principal position before a non-refundable deposit.",
        "For a condominium, review inspections, reserve study, engineering, minutes, budget, insurance, claims, litigation, assessments and rental rules.",
        "For a house, inspect roof, impact openings, permits, drainage, electrical, plumbing, trees, pool, boundaries and any seawall or dock.",
        "Overlay current flood and evacuation maps, obtain elevation evidence where relevant and bind address-specific wind, flood, homeowners and liability terms.",
        "Obtain written municipality and association confirmation for the intended stay length, licence, certificate, tax, occupancy and manager duties.",
        "Recalculate property tax, model five-year owner costs and test lawful long-term rent, permitted short stay and no rent.",
        "Compare matched completed sales and ask two independent agents to identify the future buyer pool and likely objections under a slower market.",
    ),
    references_intro="Legal, immigration, healthcare, condominium, rental, tax, airport, hazard, insurance, market and listing claims were reviewed on 24 August 2026. Recheck every time-sensitive source no later than 24 February 2027 and immediately after any Florida law, immigration, Medicare, condominium, reserve, rental, flood, insurance, tax, airport, market-data or listing change. Obtain current Florida legal, U.S. immigration and tax, insurance and property advice for the exact buyer, entity, address and intended use. Asking evidence and public market signals are not valuations or availability guarantees.",
    references=(
        {"label": "United States property guide", "url": "/countries/united-states-property/"},
        {"label": "Where can foreigners buy property?", "url": "/where-can-foreigners-buy-property/"},
        ...
        {"label": "Florida Statutes section 692.203", "url": "https://www.leg.state.fl.us/Statutes/index.cfm?App_mode=Display_Statute&URL=0600-0699%2F0692%2FSections%2F0692.203.html"},
        {"label": "USCIS: EB-5 immigrant investor programme", "url": "https://www.uscis.gov/eb-5"},
        {"label": "Medicare: eligibility basics", "url": "https://www.medicare.gov/basics/get-started-with-medicare"},
        {"label": "Florida DBPR: condominium milestone inspections", "url": "https://condos.myfloridalicense.com/inspections/"},
        {"label": "Florida DBPR: condominium safety FAQ", "url": "https://condos.myfloridalicense.com/faqs/"},
        {"label": "Miami-Dade: residential short-term vacation rentals", "url": "https://wwwx.miamidade.gov/global/economy/neighborhood-compliance/residential-short-term-vacation-rentals.page"},
        {"label": "Miami Beach: vacation and short-term rentals", "url": "https://www.miamibeachfl.gov/business/vacation-short-term-rentals/"},
        {"label": "Fort Lauderdale: vacation-rental registration", "url": "https://www.fortlauderdale.gov/government/departments-a-h/community-services/community-enhancement-and-compliance/administrative-services/vacation-rental-program/property-registration"},
        ...
        {"label": "Miami-Dade: hurricane evacuation lookup", "url": "https://www.miamidade.gov/global/emergency/hurricane/emergency-information-lookup.page"},
        {"label": "Citizens: current flood requirements", "url": "https://www.citizensfla.com/en/flood"},
        {"label": "Citizens: why flood insurance is separate", "url": "https://securesupport.citizensfla.com/app/answers/detail/a_id/2784/~/why-do-i-need-flood-insurance%3F"},
        {"label": "Florida Revenue: property-tax exemptions", "url": "https://floridarevenue.com/property/Pages/Taxpayers_Exemptions.aspx"},
        {"label": "Florida Revenue: property-tax buyer guide", "url": "https://floridarevenue.com/property/Documents/pt107.pdf"},
        {"label": "IRS: FIRPTA withholding", "url": "https://www.irs.gov/individuals/international-taxpayers/firpta-withholding"},
        {"label": "IRS: nonresident U.S. real-property income", "url": "https://www.irs.gov/individuals/international-taxpayers/nonresident-aliens-real-property-located-in-the-us"},
        {"label": "Miami International Airport: traffic and network", "url": "https://www.miami-airport.com/about_us.asp"},
        {"label": "FLL: 2025 historic airport traffic", "url": "https://www.broward.org/Airport/Business/about/Documents/FLLhistoricairporttraffic2025.pdf"},
        {"label": "Jackson Memorial Hospital", "url": "https://jacksonhealth.org/locations/jackson-memorial-hospital/"},
        {"label": "Broward Health Medical Center", "url": "https://www.browardhealth.org/locations/broward-health-medical-center"},
        {"label": "Miami-Dade July 2026 market report", "url": "https://www.miamirealtors.com/2026/08/17/miami-dade-total-home-sales-rise-for-11th-consecutive-month/"},
        {"label": "Broward July 2026 market report", "url": "https://www.miamirealtors.com/2026/08/17/broward-county-total-home-sales-increase-for-fifth-consecutive-month/"},
        {"label": "Brickell asking observation", "url": "https://www.compass.com/homedetails/68-SE-6th-St-Unit-3506-Miami-FL-33131/1CREDQ_pid/"},
        {"label": "Galt Ocean asking observation", "url": "https://www.coldwellbankerhomes.com/fl/fort-lauderdale/4280-galt-ocean-dr-14k/pid_73165529/"},
        {"label": "Coral Gables asking observation", "url": "https://www.coldwellbankerhomes.com/fl/coral-gables/1201-obispo-ave/pid_70366747/"},
    ),
    images=(
        DossierImage("hero", "/assets/miami-fort-lauderdale-waterfront-hero.webp", "Biscayne Bay waterfront with Miami skyline and palms in calm morning light", "Miami's appeal begins with a genuine global city at the water's edge.", "hero"),
        DossierImage("residential-life", "/assets/miami-fort-lauderdale-residential-life.webp", "Coral Gables Mediterranean Revival home on a shaded residential street", "The strongest retirement home makes ordinary neighbourhood life work.", "wide"),
        DossierImage("coastal-diligence", "/assets/miami-fort-lauderdale-coastal-diligence.webp", "Fort Lauderdale Intracoastal seawall, homes and condominiums after coastal weather", "Waterfront value depends on the building, drainage, seawall and insurance—not the view alone.", "wide"),
    ),
    nav_items=(("verdict", "Verdict"), ("lenses", "Five destination lenses"), ("scores", "Atlas assessment"), ("listings", "What homes cost"), ("locations", "Where to look"), ("checklist", "Buyer checklist"), ("sources", "References")),
    lenses_heading="Miami / Fort Lauderdale through five destination lenses",
    assessment_intro="Here’s how Miami / Fort Lauderdale scores on the ten factors that matter most when choosing a long-term home abroad.",
    listings_intro="The current observations range from a $659,999 Brickell apartment to a $1.48 million Coral Gables house, with a larger $849,000 Galt Ocean apartment between them. Each unit-price comparison uses seller-stated living area. Association charges, tax, insurance, condition and building records remain separate buyer costs, so these asks illustrate trade-offs rather than a market average.",
    market_anchors_intro="These are county-wide completed-sale signals—not valuations. They cover different property types, exclude much new development and cannot replace matched sales, building records or an independent appraisal for the exact home.",
    orientation_groups=(
        DossierOrientationGroup("Miami-Dade", (("MIA", "Primary global gateway"), ("Brickell / Downtown", "Urban apartment base"), ("Coral Gables / Coconut Grove", "Greener residential belt"), ("Miami Beach / Aventura", "Coastal condo choices"))),
        DossierOrientationGroup("Broward", (("FLL", "Second international gateway"), ("Las Olas / Downtown", "City and services"), ("Broward Health", "Major hospital base"), ("Galt Ocean / Lauderdale-by-the-Sea", "Residential coast"))),
    ),
    orientation_caption="Orientation schematic—not to scale. Confirm current airport, hospital, evacuation and everyday routes from the exact address at relevant times.",
    country_guide_url="/countries/united-states-property/",
    country_guide_label="United States property guide",
    rail_comparison="Compare Miami / Fort Lauderdale with the full Atlas.",
)
...
DA_NANG_HOI_AN_DOSSIER = PremiumDossierSpec(
    ...
    market_anchors=(
        {"location": "Bạch Đằng: Lê Duẩn–Nguyễn Văn Linh", "evidence": "₫340.97m/m²", "buyer_read": "Official 2025 statutory residential-land schedule, position 1, retained for the former Da Nang area in 2026. It indicates central land-value intensity; it is not an apartment price and does not value Masteri Rivera's building, usable area or rights.", "source_label": "Da Nang Decision 45 residential-land schedule", "source_url": "https://baodanang.vn/da-nang-dieu-chinh-bang-gia-dat-tiem-can-gia-thi-truong-3265012.html"},
        {"location": "Mai Đăng Chơn: Trần Đại Nghĩa–Nguyễn Bỉnh Khiêm school", "evidence": "₫34.50m/m²", "buyer_read": "Official 2025 statutory residential-land schedule, position 1, retained for the former Da Nang area in 2026. It gives southern-corridor land context; it is not an apartment price and does not value FPT Plaza 2 or its usable area.", "source_label": "Da Nang Decision 45 residential-land schedule", "source_url": "https://baodanang.vn/da-nang-dieu-chinh-bang-gia-dat-tiem-can-gia-thi-truong-3265012.html"},
        {"location": "Võ Nguyên Giáp: Phạm Văn Đồng–Võ Văn Kiệt", "evidence": "₫279.64m/m²", "buyer_read": "Official 2025 statutory residential-land schedule, position 1, retained for the former Da Nang area in 2026. It shows the coastal road's land-value signal; it is not an apartment price and does not value Altara Suites, amenities or legal use.", "source_label": "Da Nang Decision 45 residential-land schedule", "source_url": "https://baodanang.vn/da-nang-dieu-chinh-bang-gia-dat-tiem-can-gia-thi-truong-3265012.html"},
    ),
    property_anchor_indexes=(0, 1, 2),
    ...
    references=(
        ...
        {"label": "Decree 54/2026/NĐ-CP amending housing and real-estate decrees", "url": "https://vanban.chinhphu.vn/?docid=216924&pageid=27160"},
        {"label": "Ministry of Construction: consolidated Housing Law implementation", "url": "https://moc.gov.vn/pl/Pages/ChiTietVanBan.aspx?TypeVB=2&vID=656"},
        ...
        {"label": "Vietnam Ministry of Health: Da Nang Hospital registry", "url": "https://benhandientu.moh.gov.vn/benh-vien/587/benh-vien-da-nang"},
        ...
        {"label": "Ministry of Finance: consolidated registration-fee decree", "url": "https://vanban.chinhphu.vn/?classid=0&docid=215061&pageid=27160"},
        {"label": "Da Nang Decision 45/2025: statutory land schedule", "url": "https://vbpl.vn/danang/Pages/vbpq-toanvan.aspx?ItemID=178929"},
        {"label": "Da Nang Resolution 32/2025: 2026 continuation of the land schedule", "url": "https://vbpl.vn/danang/Pages/vbpq-toanvan.aspx?ItemID=185433&Keyword="},
        {"label": "Da Nang official report: Decision 45 residential-land benchmarks", "url": "https://baodanang.vn/da-nang-dieu-chinh-bang-gia-dat-tiem-can-gia-thi-truong-3265012.html"},
    ...
    market_anchors_intro="No current official Da Nang completed-apartment series was identified. The three comparisons instead use position-1 residential-land values from Decision 45/2025, which Resolution 32/2025 retains for the former Da Nang area in 2026. They show a statutory land-value gradient—not apartment prices, completed sales or candidate valuations. Reconcile every unit for building value, usable area, legal rights, condition, project status and matched completed evidence.",
    orientation_groups=(
        DossierOrientationGroup("Da Nang core", (("DAD airport", "Close urban gateway"), ("Hai Chau / Han River", "Central services"), ("Da Nang Hospital", "Ministry-registered public hospital"), ("My Khe / Son Tra", "Residential coast"))),
...
ANDERMATT_DOSSIER = PremiumDossierSpec(
    destination_id="andermatt",
    title="Andermatt Property Dossier for Foreign Buyers",
    description="Assess Andermatt property through the project-specific Lex Koller exemption, residence, access, healthcare, holiday letting, hazards, costs, current listings and resale.",
    h1="Andermatt: exceptional access, narrowly defined",
    lede=(
    ...
    lenses_intro="Five questions decide whether Andermatt works beyond a ski week: whether ordinary life is sufficiently complete, how the Göschenen connection performs, what the exact exemption covers, whether rental economics survive full costs, and which future buyer can understand the asset.",
    lenses=(
        DossierLens("Live in a high valley, not a resort brochure", ("lifestyle_magnetism", "retirement_fit"), (
        ...
        DossierLens("Make the Göschenen connection part of the decision", ("global_access", "foreigner_fit"), (
        ...
        DossierLens("Confirm the exemption, then inspect the building", ("ownership_clarity", "regulatory_safety"), (
        ...
        DossierLens("Treat holiday letting as a contract, not a yield", ("rental_profit", "capital_upside"), (
        ...
        DossierLens("Pay for the legal package and preserve the exit", ("value_entry", "exit_liquidity"), (
    ...
    score_reads={
        "lifestyle_magnetism": "Andermatt combines a dramatic Ursern Valley setting with credible winter and summer use, but shoulder-season services remain compact.",
        "global_access": "Andermatt station connects through Göschenen, while airports and specialist services require a longer rail or weather-sensitive road journey.",
        "ownership_clarity": "The Andermatt tourism-project exemption runs through 2040, but every buyer, parcel and ownership vehicle still requires written cantonal confirmation.",
        "regulatory_safety": "Andermatt ownership requires project, condominium, rental and address-level avalanche, flood and rockfall review before commitment.",
        "rental_profit": "Andermatt has no verified destination-wide yield; hotel residences, resort condos and ordinary homes require separate lawful-use and cost evidence.",
        "capital_upside": "Andermatt infrastructure and project sales are supportive context, not proof of future appreciation for a selected unit.",
        "retirement_fit": "Andermatt offers walkability and active mountain life, while hospital and specialist care require a clear Altdorf and regional plan.",
        "exit_liquidity": "Andermatt’s exempt project can reach international buyers, yet absolute price, contracts and the 2040 horizon can narrow resale.",
        "foreigner_fit": "Andermatt Reuss offers international ownership services, but Swiss residence, tax, banking and local management remain separate obligations.",
        "value_entry": "Andermatt entry prices are high and asset-specific; parking, furniture, hotel rights, area basis and service charges must be reconciled."
    },
    market_anchors=(
        {"location":"Andermatt tax land-value zone 1","evidence":"500 CHF/m²","buyer_read":"Highest Andermatt land parameter in the cantonal schedule effective 11 January 2025, with a 2006 value basis; a tax-assessment input, not current market evidence or a candidate valuation.","source_label":"Canton Uri valuation parameters","source_url":"https://www.ur.ch/_doc/406051"},
        {"location":"Andermatt tax land-value zone 4","evidence":"300 CHF/m²","buyer_read":"Mid-schedule Andermatt land parameter effective 11 January 2025; the zone must be mapped to the parcel and the value is not a finished-home market price.","source_label":"Canton Uri valuation parameters","source_url":"https://www.ur.ch/_doc/406051"},
        {"location":"Andermatt tax land-value zone 7","evidence":"40 CHF/m²","buyer_read":"Lowest listed Andermatt land parameter effective 11 January 2025; useful only to show assessment-zone dispersion, not to price a resort unit or candidate parcel.","source_label":"Canton Uri valuation parameters","source_url":"https://www.ur.ch/_doc/406051"},
    ),
    micro_locations_intro="Andermatt is a sequence of legal and daily-life patterns, not one price zone. Confirm the exact project boundary, parcel, station route, building governance, hazard layers and healthcare journey.",
    micro_locations=(
        {"name":"Andermatt Reuss","best_for":"Newer exempt-project ownership","daily_life":"Station-led and managed","diligence":"Project status, fees, operator and resale"},
        {"name":"Old village / Gemsstock","best_for":"Traditional fabric and lift access","daily_life":"Walkable but building-specific","diligence":"Lex Koller status, condition, snow and noise"},
        {"name":"Hospental","best_for":"Quieter valley living","daily_life":"Rail or car dependent","diligence":"Ordinary ownership rules, services and hazards"},
        {"name":"Realp / upper valley","best_for":"Space and seclusion","daily_life":"Small service base and seasonal access","diligence":"Residence use, transport, avalanche and exit pool"},
    ),
    checklist=("Confirm residence and health insurance separately.","Obtain written Lex Koller treatment for the buyer and parcel.","Verify title, project boundary, condominium rules and service contracts.","Confirm lawful rental use, tourism charges and operator economics.","Reconcile internal area, parking, furniture and every mandatory add-on.","Review avalanche, flood, rockfall, snow load and insurance.","Test Göschenen, Altdorf and airport journeys in difficult weather.","Obtain independent valuation and resale opinions before signing."),
    ...
    references=(
        ...
        {"label":"Federal Office of Justice: acquisition by persons abroad","url":"https://www.bj.admin.ch/de/grundstueckerwerb-durch-personen-im-ausland"},
        {"label":"Federal Office of Justice: Andermatt tourism-project exemption","url":"https://www.bj.admin.ch/de/nsb?id=7468"},
        {"label":"Canton Uri: Lex Koller and the Andermatt exception","url":"https://www.ur.ch/wirtschaft/6658"},
        {"label":"SEM: residence requirements","url":"https://www.sem.admin.ch/sem/en/home/integration-einbuergerung/mein-beitrag/zugewandert/rechtl-erfordernisse.html"},
        {"label":"SEM: EU/EFTA residence without gainful activity","url":"https://www.sem.admin.ch/sem/en/home/themen/fza_schweiz-eu-efta/eu-efta_buerger_schweiz/faq.html"},
        {"label":"SBB: Andermatt station","url":"https://www.sbb.ch/de/reiseinformationen/bahnhoefe/bahnhof-finden/bahnhof.5165.andermatt.html"},
        {"label":"SBB: Swiss rail network map","url":"https://company.sbb.ch/content/dam/infrastruktur/trafimage/karten/karte-netzkarte-schweiz.pdf.sbbdownload.pdf/"},
        {"label":"Kantonsspital Uri: 24-hour rescue service","url":"https://www.ksuri.ch/fachbereiche/anaesthesie-2/fachbereiche/rettungsdienst/uebersicht"},
        {"label":"Canton Uri: land-register fee tariff","url":"https://www.ur.ch/online-schalter/2127/download"},
        {"label":"Canton Uri: real-estate gains tax","url":"https://www.ur.ch/finanzen/1585"},
        {"label":"Canton Uri: Andermatt land-valuation parameters","url":"https://www.ur.ch/_doc/406051"},
        {"label":"Canton Uri: better use of second homes","url":"https://www.ur.ch/dienstleistungen/4632"},
        {"label":"Canton Uri: second-home policy material","url":"https://www.ur.ch/_docn/103551/Checkliste_Zweitwohnungen.pdf"},
        {"label":"Federal environment office: natural-hazard maps","url":"https://www.bafu.admin.ch/de/naturgefahren-karten"},
        {"label":"Federal environment office: hazard-map interpretation","url":"https://www.bafu.admin.ch/de/gefahrenkarten"},
        {"label":"Andermatt Swiss Alps: real-estate portfolio and ownership services","url":"https://www.andermatt-swissalps.ch/en/real-estate/"},
        {"label":"Andermatt Swiss Alps: project sales and average-price history","url":"https://corporate.andermatt-swissalps.ch/en/media-releases/increase-in-property-sales-revenue-at-andermatt-swiss-alps-net-profit/"},
        {"label":"European Central Bank: exchange rates","url":"https://www.ecb.europa.eu/stats/policy_and_exchange_rates/euro_reference_exchange_rates/html/index.en.html"},
    ),
    images=(
        DossierImage("valley-hero","/assets/andermatt-valley-hero.webp","Andermatt village and railway in the Ursern Valley","Andermatt’s value begins with a complete high-valley settlement, not a single ski asset.","hero","defining-place"),
        DossierImage("village-access","/assets/andermatt-village-access.webp","Andermatt station and contemporary village buildings","The station and compact valley floor shape ordinary access.","wide","built-environment-access"),
        DossierImage("winter-diligence","/assets/andermatt-winter-diligence.webp","Snow-covered Andermatt residential buildings beside a cleared mountain road","Snow, drainage and emergency access remain ownership questions.","wide","decision-texture"),
    ),
    nav_items=(("verdict","Verdict"),("lenses","Five destination lenses"),("scores","Atlas assessment"),("listings","What homes cost"),("locations","Where to look"),("checklist","Buyer checklist"),("sources","References")),
    lenses_heading="Andermatt through five destination lenses",
    assessment_intro="Here’s how Andermatt scores on the ten factors that matter most when choosing a long-term home abroad.",
    ...
    market_anchors_intro="Official cantonal land-assessment parameters show the spread between Andermatt tax zones. They are unmatched background context: the source does not identify the zone of any listed property, the inputs use a 2006 value basis, and none is current market evidence or a candidate valuation.",
    orientation_groups=(DossierOrientationGroup("Gotthard and Ursern access",(("Zurich / Lucerne","Air gateway and specialist services"),("Göschenen","Mainline rail interchange"),("Andermatt","Station, old village and Reuss"),("Hospental / Realp","Upper-valley residential pattern"))),),
    orientation_caption="Orientation schematic—not to scale. Confirm the exact rail, road, hospital, hazard and seasonal-access journey for the address.",
    country_guide_url="/countries/switzerland-property/",
    country_guide_label="Switzerland property guide",
    rail_comparison="Compare Andermatt with the full Atlas.",
