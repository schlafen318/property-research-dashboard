    ...
    <section class="calculator-layout" aria-label="Retirement calculator">
      <form class="calc-panel" id="retirement-calculator" novalidate>
        ...
        <fieldset><legend>Destination and housing</legend><div class="field-grid">
          ...
          <div class="field"><label for="ret-monthly-spending">Monthly spending today (USD)</label><input id="ret-monthly-spending" type="number" min="0" step="1" value="0"><p class="hint" id="ret-housing-guidance">Includes owner running costs after purchase, not rent. Enter the home purchase budget separately.</p></div>
