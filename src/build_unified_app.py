...
def build_seo_page(
    ...
    if page["slug"] == "japan-retirement-property-foreign-buyers":
        editorial_content = """
          ...
          <section class="seo-section"><h2>Budget, finance, and operating reality</h2><p>Do not confuse the asking price with the cost of owning a Japanese home. Build a separate annual budget for acquisition taxes and fees, property taxes, insurance, utilities, management, repairs, furnishings, and a reserve for a building or roof that cannot wait for your next visit. Finance should be treated as a separate workstream: confirm what a lender will actually offer to your residency and income profile before letting leverage shape the shortlist.</p><p>Non-resident reporting is not a footnote. Japan's Ministry of Finance says a report under FEFTA is generally required for a non-resident acquiring Japanese real property or rights in it, and must be submitted via the Bank of Japan within 20 days after acquisition. Confirm whether an exemption applies with Japanese counsel before completion.</p></section>
