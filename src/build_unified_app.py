...
COUNTRY_HUBS = [
    ...
    },
    {
        ...
        "country": "France",
        "title": "France Property Guide for Foreign Buyers | Global Home Atlas",
        "description": "Assess France property for foreign buyers through residence, healthcare, the notarised purchase process, diagnostics, copropriété rules, tourist letting, tax, hazards, and destination dossiers for Annecy and Chamonix.",
        "h1": "France Property Guide for Foreign Buyers",
        "thesis": "France offers a familiar notarised purchase system, strong public infrastructure and deep lifestyle markets, but a deed does not create residence or healthcare rights. The decisive work is local: establish the buyer's status and tax position, then verify the exact title, diagnostics, copropriété, planning, permitted use, costs and hazards.",
        "country_rules": [
            {"heading": "Property and residence are separate", "text": "Buying a French home does not create immigration status. Non-EU retirees should establish the appropriate long-stay route before purchase; the visitor route has separate resources, accommodation, medical-cover and no-work requirements."},
            {"heading": "The notaire controls the transfer", "text": "A French sale is completed through a notaire, but the buyer still needs property-specific diligence on title, easements, planning, diagnostics, tax, finance and ownership structure. Obtain a written acquisition-cost estimate for the exact transaction rather than applying a universal percentage."},
            {"heading": "Copropriété and energy affect use", "text": "Apartment buyers should review the règlement, meeting minutes, charges, arrears, insurance and voted works. DPE rules affect energy performance and the ability to let poorly performing homes; local building governance may add further restrictions."},
            {"heading": "Tourist letting is local and evolving", "text": "Registration, change-of-use, primary-residence, DPE, municipal and copropriété rules can differ by commune and building. A prior listing or rental history does not prove that the purchaser can continue the same use."},
        ],
        "primary_sources": [
            ...
            {"label": "Service Public: buying a home", "url": "https://www.service-public.fr/particuliers/vosdroits/N23245"},
            {"label": "Service Public: copropriété information for buyers", "url": "https://www.service-public.fr/particuliers/vosdroits/F2604"},
            {"label": "Service Public: DPE and rental energy rules", "url": "https://www.service-public.fr/particuliers/vosdroits/F16096"},
            {"label": "Service Public: 2024 furnished-tourist-let reforms", "url": "https://www.service-public.fr/entreprendre/actualites/A17883"},
            {"label": "French tax administration: non-resident property income", "url": "https://www.impots.gouv.fr/international-particulier/questions/i-receive-property-income-source-france"},
            {"label": "Géorisques: property and commune risk search", "url": "https://www.georisques.gouv.fr/"},
        ],
        "destination_ids": ["annecy", "chamonix"],
    ...
    },
    {
        ...
        "description": "Compare Vancouver, Vancouver Island and Whistler property for foreign buyers across city, island and mountain lifestyles, retirement practicality, rental rules, tax and policy considerations.",
        ...
        "country_rules": [
            ...
            {"heading": "Foreign-buyer and vacancy taxes stack", "text": "Federal Underused Housing Tax filing and payment obligations were eliminated for 2025 and later calendar years, although earlier-year obligations can remain. Provincial additional property transfer tax, B.C. speculation and vacancy tax and any local vacancy tax use different definitions, returns and exemptions. Model each applicable regime separately for the buyer and property."},
        ],
        "primary_sources": [
            ...
            {"label": "Canada Revenue Agency: Underused Housing Tax", "url": "https://www.canada.ca/en/revenue-agency/services/forms-publications/publications/uhtn1/introduction-underused-housing-tax.html"},
    ...
    },
    {
        ...
        "title": "United Arab Emirates Property Guide for Foreign Buyers | Global Home Atlas",
        "description": "Assess United Arab Emirates property for foreign buyers through Dubai ownership areas, residence, registration fees, VAT, licensed holiday homes, service charges and resale discipline.",
        "h1": "United Arab Emirates Property Guide for Foreign Buyers",
        "thesis": "The United Arab Emirates offers a well-used international purchase pathway in designated ownership areas, but a deed is not a residence permit and a clear registration process does not make every project equally safe. Begin with the exact title and finished asset, then price residence, tax, service charge, permitted use and exit separately.",
        "country_rules": [
            {"heading": "Designated ownership areas", "text": "Foreign freehold ownership is available in areas designated by the relevant emirate. In Dubai, confirm the exact plot and unit through Dubai Land Department records; a district name, marketing brand or view does not by itself establish the title classification."},
            {"heading": "Property and residence are separate", "text": "Buying a UAE home does not itself create a right to reside. Real-estate investors may qualify for a five-year Golden visa when the current AED 2 million and other conditions are met, but eligibility and approval are separate from the transfer."},
            {"heading": "Residential VAT and registration fees", "text": "Dubai Land Department lists seller and buyer registration fees plus trustee, title and map charges. The Federal Tax Authority generally treats residential real estate differently from commercial or serviced accommodation. Obtain a buyer- and asset-specific completion statement and tax analysis."},
            {"heading": "Licensed holiday-home operation", "text": "Dubai holiday homes operate under a licensing and unit-permit framework. A residential title, online listing or operator forecast does not prove that the exact unit and intended stay pattern comply; verify tourism, building, management and tax requirements in writing."},
        ],
        "primary_sources": [
            {"label": "Dubai Land Department: foreign ownership FAQ", "url": "https://dubailand.gov.ae/en/frequently-asked-questions"},
            ...
            {"label": "Federal Tax Authority: VAT real-estate guide", "url": "https://www.tax.gov.ae/DownloadOpenTextFile?fileUrl=en%2FVAT_VAT_Guides%2FReal_Estate_Guide%2FReal_Estate_Guide_VATGRE1_EN_19_04_2021_EN.pdf"},
        ...
        "destination_ids": ["dubai"],
        "guide_slugs": ["where-can-foreigners-buy-property", "foreign-property-investment-risks", "overseas-property-investment", "best-countries-to-buy-property-as-a-foreigner"],
    },
    {
    ...
    },
    {
        ...
        "country": "Vietnam",
        "title": "Vietnam Property Guide for Foreign Buyers | Global Home Atlas",
        "description": "Assess Vietnam property for foreign buyers through Da Nang and Hoi An, including residence, qualifying commercial-housing projects, foreign quotas, ownership terms, apartment use, hazards, tax and resale.",
        "h1": "Vietnam Property Guide for Foreign Buyers",
        "thesis": "Vietnam offers accessible coastal-city property and strong regional growth, but foreign ownership is a defined project-and-unit pathway rather than open access to any advertised home. Establish residence independently, then verify the exact project's eligibility, restricted-area status, foreign quota, certificate term, permitted use, costs, hazards and future buyer pool.",
        "country_rules": [
            {"heading": "Property and residence are separate", "text": "Buying a Vietnamese home does not create immigration status. The official e-visa is currently valid for up to 90 days, single or multiple entry, and is not a retirement residence route. Establish the lawful long-stay, healthcare and tax plan independently."},
            {"heading": "Foreign ownership is project-specific", "text": "Eligible foreign individuals who are permitted to enter Vietnam may own specified housing in qualifying commercial-housing projects, subject to restricted defence and security areas and the exact project's legal status. A portal listing or developer reservation is not proof of eligibility."},
            {"heading": "Quota and term control the unit", "text": "Foreign ownership in an apartment building is capped at 30% of the units. The ordinary foreign-individual ownership term is up to 50 years from the certificate, with any extension requiring the prescribed application and approval. Confirm current quota, certificate route and remaining term in writing."},
            {"heading": "Residential title does not prove tourist use", "text": "Current housing guidance prohibits using condominium apartments for non-residential purposes, while tourist accommodation is governed separately. Confirm the exact approved function, building rules, operator licensing, tax and municipal requirements before assigning short-stay income."},
            {"heading": "Registration cost and resale are unit-specific", "text": "Current consolidated Ministry of Finance guidance sets the general house-and-land registration-fee rate at 0.5%, but the taxable base, exemptions, contract taxes and other charges depend on the transaction. Exit also depends on the remaining ownership term, certificate, project status and next eligible buyer. Obtain a buyer-specific closing and resale statement rather than applying one total-cost percentage."},
        ],
        "primary_sources": [
        ...
        "destination_ids": ["da-nang-hoi-an"],
        "guide_slugs": ["where-can-foreigners-buy-property", "foreign-property-investment-risks", "buying-property-abroad-for-retirement", "best-places-to-buy-a-second-home-abroad"],
    },
    {
        "slug": "indonesia-property",
        "country": "Indonesia",
        "title": "Indonesia Property Guide for Foreign Buyers | Global Home Atlas",
        "description": "Assess Indonesia property for foreign buyers through Bali ownership rights, leases, residence, licensing, tax, hazards, and exit discipline.",
        "h1": "Indonesia Property Guide for Foreign Buyers",
        "thesis": "Indonesia can deliver exceptional lifestyle and hospitality demand, but a Bali villa advertisement is not a title opinion, residence permit or operating licence. Establish the buyer's lawful land or contractual interest first, then test permitted use, tax, remaining term, infrastructure, hazards and exit separately.",
        "country_rules": [
            {"heading": "Foreign freehold is not the default", "text": "Indonesia's Basic Agrarian Law reserves Hak Milik ownership to Indonesian citizens. Foreign residents may be eligible for Hak Pakai, while many marketed Bali villas are contractual leasehold interests. The exact land certificate, building rights, parties and registration must be independently verified."},
            {"heading": "A lease is a wasting contractual asset", "text": "A lease price must be read together with commencement, expiry, extension language, rent-reset method, landlord identity, succession, default, assignment and building ownership. An advertised extension option is not the same as a prepaid or enforceable extension at a known price."},
            {"heading": "Residence is separate", "text": "Buying or leasing a Bali home does not itself create immigration status. Indonesia lists separate E33E and E33F retiree special-residency visas; eligibility, duration, sponsor or guarantee and financial conditions must be confirmed for the applicant before purchase."},
            {"heading": "Hospitality use needs its own legal route", "text": "OSS classifies villa accommodation under KBLI 55193. A residential building, online listing, local operator or seller forecast does not prove that the exact land use, building approvals, business entity, licence, tax and neighbourhood conditions support paid short stays."},
        ],
        "primary_sources": [
            ...
            {"label": "Directorate General of Taxes: property lease income", "url": "https://pajak.go.id/id/pemotongan-pajak-penghasilan-pasal-4-ayat-2-1"},
        ],
        "destination_ids": ["bali"],
        "guide_slugs": ["where-can-foreigners-buy-property", "foreign-property-investment-risks", "overseas-property-investment", "best-places-to-buy-a-second-home-abroad"],
    },
    {
  ...
  <main><div class="calc-shell">
    ...
    <section class="calculator-layout" aria-label="Retirement calculator">
      ...
      <section class="calc-panel result-panel" id="ret-results" aria-live="polite" aria-atomic="true">
        ...
        <p class="result-decision" id="ret-plan-summary">Central estimate needed today: —.</p>
        ...
        <p><button class="text-button" id="ret-tax-refine" type="button" hidden disabled>Refine this tax estimate</button></p><p class="hint" id="ret-tax-refine-status" role="status" hidden>Detailed tax refinement is not available yet. The displayed planning range remains unchanged.</p>
    ...
    <section class="calc-panel current-cost-comparison" id="ret-current-cost-comparison" hidden aria-labelledby="ret-current-cost-heading">
      ...
      <div class="current-cost-layout">
        <div class="field-grid">
          ...
          <div class="field"><label for="ret-current-monthly-spending">Current monthly spending</label><input id="ret-current-monthly-spending" type="text" inputmode="numeric" data-money min="1" step="1" placeholder="Enter amount"><p class="hint">Include housing and use the same household basis as the destination estimate.</p></div>
        </div>
